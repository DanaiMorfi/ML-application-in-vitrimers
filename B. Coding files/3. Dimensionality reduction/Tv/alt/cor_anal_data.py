...
df_cleaned = df_cleaned.drop(columns=['Tm2 (oC)', 'Swelling ratio (%)','Crosslink density (mol/m3)','Tg (oC)','Gel fraction (%)',
'Pre-exponential factor (s-1)', 'Ea (kJ/mol)', 'Youngs modulus (MPa)','Tensile strength (MPa)'])
